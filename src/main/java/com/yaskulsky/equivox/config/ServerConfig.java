...
import com.yaskulsky.equivox.config.value.CachedBooleanValue;
import com.yaskulsky.equivox.config.value.CachedDoubleValue;
import com.yaskulsky.equivox.config.value.CachedFloatValue;
import com.yaskulsky.equivox.config.value.CachedIntValue;
