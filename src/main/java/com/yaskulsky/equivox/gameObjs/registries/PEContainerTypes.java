...
public class PEContainerTypes {
	...
	public static final ContainerTypeRegistryObject<TransmutationProviderContainer> TRANSMUTATION_PROVIDER_CONTAINER = CONTAINER_TYPES.register(PEBlocks.TRANSMUTATION_PROVIDER, TransmutationProviderBlockEntity.class, TransmutationProviderContainer::new);
