...
import com.yaskulsky.equivox.gameObjs.items.CataliticLens;
import com.yaskulsky.equivox.gameObjs.items.DestructionCatalyst;
import com.yaskulsky.equivox.gameObjs.items.DiviningRod;
import com.yaskulsky.equivox.gameObjs.items.EvertideAmulet;
import com.yaskulsky.equivox.gameObjs.items.GemEternalDensity;
import com.yaskulsky.equivox.gameObjs.items.HyperkineticLens;
import com.yaskulsky.equivox.gameObjs.items.KleinStar;
import com.yaskulsky.equivox.gameObjs.items.KleinStar.KleinTier;
import com.yaskulsky.equivox.gameObjs.items.MercurialEye;
...
import com.yaskulsky.equivox.gameObjs.items.armor.GemLegs;
import com.yaskulsky.equivox.gameObjs.items.armor.RMArmor;
import com.yaskulsky.equivox.gameObjs.items.rings.Arcana;
import com.yaskulsky.equivox.gameObjs.items.rings.ArchangelSmite;
import com.yaskulsky.equivox.gameObjs.items.rings.BlackHoleBand;
import com.yaskulsky.equivox.gameObjs.items.rings.BodyStone;
import com.yaskulsky.equivox.gameObjs.items.rings.HarvestGoddess;
import com.yaskulsky.equivox.gameObjs.items.rings.Ignition;
import com.yaskulsky.equivox.gameObjs.items.rings.LifeStone;
import com.yaskulsky.equivox.gameObjs.items.rings.MindStone;
import com.yaskulsky.equivox.gameObjs.items.rings.SWRG;
import com.yaskulsky.equivox.gameObjs.items.rings.SoulStone;
import com.yaskulsky.equivox.gameObjs.items.rings.TimeWatch;
import com.yaskulsky.equivox.gameObjs.items.rings.VoidRing;
import com.yaskulsky.equivox.gameObjs.items.rings.Zero;
import com.yaskulsky.equivox.gameObjs.items.tools.PEAxe;
import com.yaskulsky.equivox.gameObjs.items.tools.PEHammer;
import com.yaskulsky.equivox.gameObjs.items.tools.PEHoe;
import com.yaskulsky.equivox.gameObjs.items.tools.PEKatar;
import com.yaskulsky.equivox.gameObjs.items.tools.PEMorningStar;
import com.yaskulsky.equivox.gameObjs.items.tools.PEPickaxe;
import com.yaskulsky.equivox.gameObjs.items.tools.PEShears;
import com.yaskulsky.equivox.gameObjs.items.tools.PEShovel;
import com.yaskulsky.equivox.gameObjs.items.tools.PESword;
import com.yaskulsky.equivox.gameObjs.items.tools.RedMatterSword;
import com.yaskulsky.equivox.gameObjs.registration.impl.ItemDeferredRegister;
