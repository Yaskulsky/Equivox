...
import com.yaskulsky.equivox.api.data.WorldTransmutationBuilder;
import com.yaskulsky.equivox.api.data.WorldTransmutationProvider;
...
public class PEWorldTransmutationProvider extends WorldTransmutationProvider {
	...
	protected void addWorldTransmutations(@NotNull HolderLookup.Provider registries) {
		...
		createTransmutationBuilder(PECore.rl("colors"))
				...
				.registerConsecutivePairs(Blocks.CONCRETE.asList().toArray(Block[]::new))
				.registerConsecutivePairs(Blocks.CONCRETE_POWDER.asList().toArray(Block[]::new))
				.registerConsecutivePairs(Blocks.CARPET.asList().toArray(Block[]::new))
				.registerConsecutivePairs(Blocks.WOOL.asList().toArray(Block[]::new))
				.registerConsecutivePairs(Blocks.DYED_TERRACOTTA.asList().toArray(Block[]::new))
				.registerConsecutivePairs(Blocks.STAINED_GLASS.asList().toArray(Block[]::new))
				.registerConsecutivePairs(Blocks.STAINED_GLASS_PANE.asList().toArray(Block[]::new))
		;
