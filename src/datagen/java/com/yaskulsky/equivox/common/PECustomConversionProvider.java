...
import com.yaskulsky.equivox.api.data.CustomConversionProvider;
...
public class PECustomConversionProvider extends CustomConversionProvider {
	...
	protected void addCustomConversions(@NotNull HolderLookup.Provider registries) {
		...
		createConversionBuilder(PECore.rl("defaults"))
				...
				.conversion(Items.CONCRETE.pick(DyeColor.WHITE)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.WHITE)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.ORANGE)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.ORANGE)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.MAGENTA)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.MAGENTA)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.LIGHT_BLUE)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.LIGHT_BLUE)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.YELLOW)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.YELLOW)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.LIME)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.LIME)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.PINK)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.PINK)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.GRAY)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.GRAY)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.LIGHT_GRAY)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.LIGHT_GRAY)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.CYAN)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.CYAN)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.PURPLE)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.PURPLE)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.BLUE)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.BLUE)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.BROWN)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.BROWN)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.GREEN)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.GREEN)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.RED)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.RED)).end()
				.conversion(Items.CONCRETE.pick(DyeColor.BLACK)).ingredient(Items.CONCRETE_POWDER.pick(DyeColor.BLACK)).end()
				.end()
				.group("damaged_anvil")
