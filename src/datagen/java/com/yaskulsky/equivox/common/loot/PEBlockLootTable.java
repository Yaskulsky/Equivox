package com.yaskulsky.equivox.common.loot;
...
public class PEBlockLootTable extends BlockLootSubProvider {
	...
	public PEBlockLootTable(HolderLookup.Provider registries) {
		super(Set.of(
				...
				PEBlocks.RED_MATTER_PEDESTAL.getSecondary(),
	...
	protected void generate() {
		...
		dropSelf(PEBlocks.RED_MATTER_PEDESTAL.getBlock());
		...
		dropSelf(PEBlocks.TRANSMUTATION_PROVIDER.getBlock());
